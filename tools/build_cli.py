...
def main() -> int:
    ...
    # runtime.cmake embeds Vulkan SPIR-V through tools/embed_spirv.py, and
    # PSX_ENABLE_VULKAN defaults ON, so the packaged framework needs it.
    (framework / "tools").mkdir(exist_ok=True)

"""Admit the independently replayed Resident Evil DC best-ending Nymashock source, never native output.

Publication 5963M, "Jill, best ending", on the same disc, BIOS, core and pinned
BizHawk 2.9.1 as the already qualified 5920M. A second category on a proven engine:
only the input log and its length differ, 257,271 rows against 227,202. Structure and
every check are the Mega Man X5 module's, including the movie-header firmware
cross-check; the constants below are this category's.
"""
...
MOVIE_SHA='ff7857627d7ea2af3fc2f31c7d4c721261acc3b8f4a8b386541b2b08e6f12245'
...
TITLE='Resident Evil Directors Cut (Japan) Jill Best Ending 5963M'
FIRMWARE_KEY='PSX+J'
# The firmware this movie's own header declares. Its header says
# PSX_Firmware_J B05DEF971D8EC59F346F2D9AC21FB742E3EB6917, which is SCPH-5500;
# admission cross-checks that SHA-1 against the loaded BIOS below, so this pin
# and the movie can never drift apart again.
FIRMWARE_NAME='SCPH5500.BIN'
FIRMWARE_SHA1='b05def971d8ec59f346f2d9ac21fb742e3eb6917'
FIXED={
    ...
    FIRMWARE_NAME:'9c0421858e217805f4abe18698afea8d5aa36ff0727eb8484944e00eb5e7eadb',
    'fortranm,arandomgametaser-redc-psx-jillbestending.bk2':MOVIE_SHA,'original.bk2':MOVIE_SHA,
...
def qualify(stock,observed,output):
    ...
    result={'schema':'redc-bestending-independent-source-v1','source_qualification':'pass',

"""Admit the independently replayed Mega Man X5 Nymashock source, never native output."""
...
MOVIE_SHA='d9bf88d61765f87bec3012a0226656211d911f1eedb31cdf277994690d8d56f5'
...
def qualify(stock,observed,output):
    ...
    result={'schema':'megamanx5-independent-source-v1','source_qualification':'pass',

...
/* The PS1 CPU clock is 33.8688 MHz. Keep a replacement disc hidden from the
 * guest for two seconds so software can observe a real open/close tray cycle.
 * Metal Gear Solid is known to reject a replacement that closes immediately. */
 ...
 * closed. The next GetStat can then report the inserted disc normally. */

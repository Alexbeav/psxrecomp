...
int main(void) {
    ...
    /* Each enhanced triangle remains one backend submission, at either height. */
    ...
    CHECK(mock_submissions==1 && mock_bad==0 && !mock_pc && !mock_pq);
    mock_submissions=0;

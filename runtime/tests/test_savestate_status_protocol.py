...
# (the DualShock power-on flag) made it v11 with a read floor of 11. PS1B-186
# (the rewritten source-DMA machines) made it v12 with a read floor of 12:
# every writer emits v12 and every earlier state is refused. That matches the Wave 5 rule of a clean install with no save

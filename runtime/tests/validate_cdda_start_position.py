...
from cdda_start_position_model import expected_rows
def read_check(matrix,item,commit):
 ...
 with Path(item['trace']).open() as f:
  ...
  require(meta['schema']=='t77-cdda-start-position-observations-v1','schema');require(meta['source']==identity and identity['commit']==commit,'source identity')

...
with tempfile.TemporaryDirectory(dir=scratch,prefix='cd-head-negative-') as temp:
 ...
 changes=[dict(lba=-151),dict(lba=450000),dict(target=-151),dict(target=450000),dict(mode=256),dict(clock=-1),dict(due=2**64-451584),dict(drive=2**31),dict(valid=-2**31-1),dict(hold=2**31),dict(subq=2**31),dict(clock=451584*4096),dict(mode=128,clock=225792*4096)]
